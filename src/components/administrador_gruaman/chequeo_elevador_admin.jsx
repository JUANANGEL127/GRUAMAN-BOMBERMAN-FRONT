...
function ChequeoElevadorAdmin() {
  ...
  async function handleBuscar() {
    ...
    try {
      ...
      const res = await axios.post(`${API_BASE_URL}/chequeo_elevador_admin/buscar`, body);
  ...
  async function handleDescargar(tipo) {
    ...
    try {
      ...
      const res = await axios.post(`${API_BASE_URL}/chequeo_elevador_admin/descargar`, body, { responseType: 'blob' });
