...
function ChecklistAdmin() {
  ...
  async function handleBuscar() {
    ...
    try {
      ...
      const res = await axios.post(`${API_BASE_URL}/checklist_admin/buscar`, body);
  ...
  async function handleDescargar(tipo) {
    ...
    try {
      ...
      const res = await axios.post(`${API_BASE_URL}/checklist_admin/descargar`, body, { responseType: 'blob' });
