...
function ChecklistAdmin() {
  ...
  async function handleBuscar() {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:3000/checklist_admin/buscar', body);
  ...
  async function handleDescargar(tipo) {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:3000/checklist_admin/descargar', body, { responseType: 'blob' });
      ...
      link.href = url;
      link.setAttribute('download', tipo === 'excel' ? 'checklist.xlsx' : 'checklist.zip');
  ...
  return (
    <div className="form-container">
      <div className="card-section" style={{ marginBottom: 24 }}>
        <h3 className="card-title">Checklist - Administrador</h3>
