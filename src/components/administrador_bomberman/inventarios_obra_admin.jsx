...
function InventariosObraAdmin() {
  ...
  async function handleBuscar() {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:3000/inventarios_obra_admin/buscar', body);
  ...
  async function handleDescargar(tipo) {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:3000/inventarios_obra_admin/descargar', body, { responseType: 'blob' });
  ...
  return (
    <div className="form-container">
      <div className="card-section" style={{ marginBottom: 24 }}>
        <h3 className="card-title">Inventarios de Obra - Administrador</h3>
...
export default InventariosObraAdmin;
