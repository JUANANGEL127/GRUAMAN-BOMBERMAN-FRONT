...
function PlanillaBombeoAdmin() {
  ...
  async function handleDescargar(tipo) {
    ...
    try {
      ...
      link.href = url;
      link.setAttribute('download', tipo === 'excel' ? 'planilla_bombeo.xlsx' : 'planilla_bombeo.zip');
  ...
  return (
    <div className="form-container">
      <div className="card-section" style={{ marginBottom: 24 }}>
        <h3 className="card-title">Planilla de Bombeo - Administrador</h3>
...
export default PlanillaBombeoAdmin;