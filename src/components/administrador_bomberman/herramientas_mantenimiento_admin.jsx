...
const ITEMS_LABELS = {
  ...
  extension_media_x12_a:  'EXTENSIÓN DE 1/2 X 12"',
  palanca_media_x15:       'PALANCA DE 1/2 X 15"',
  llave_bristol_14:        'LLAVE BRISTOL 14',
  llave_11:                'LLAVE 11',
  llave_12:                'LLAVE 12',
  llave_13:                'LLAVE 13',
  llave_14:                'LLAVE 14',
  llave_19:                'LLAVE 19',
  destornillador_pala:     'DESTORNILLADOR DE PALA',
  destornillador_estrella: 'DESTORNILLADOR DE ESTRELLA',
  copa_punta_10_media:     'COPA EN PUNTA 10 DE 1/2',
  extension_media_x12_b:  'EXTENSIÓN DE 1/2 X 12" (2)',
  rachet_media:            'RACHET DE 1/2',
  llave_mixta_17:          'LLAVE MIXTA 17',
  llave_expansiva_15:      'LLAVE EXPANSIVA 15"',
};
...
function HerramientasMantenimientoAdmin() {
  ...
  async function handleDescargar(tipo) {
    ...
    try {
      ...
      link.href = url;
      link.setAttribute('download', `herramientas_mantenimiento.${ext}`);
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        <div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
          ...
          <input className="permiso-trabajo-input" type="text" name="nombre"
            ...
            list="lista-nombres-hm" disabled={loading} />
          <datalist id="lista-nombres-hm">
        ...
        <div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
          ...
          <input className="permiso-trabajo-input" type="text" name="obra"
            ...
            list="lista-obras-hm" disabled={loading} />
          <datalist id="lista-obras-hm">
        ...
        <div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
          ...
          <input className="permiso-trabajo-input" type="text" name="constructora"
            ...
            list="lista-constructoras-hm" disabled={loading} />
          <datalist id="lista-constructoras-hm">
  ...
  return (
    <div className="form-container">
      <div className="card-section" style={{ marginBottom: 24 }}>
        <h3 className="card-title">Herramientas de Mantenimiento - Admin</h3>
...
export default HerramientasMantenimientoAdmin;
