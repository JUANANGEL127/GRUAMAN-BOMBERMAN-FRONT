...
function InspeccionEPCCBombermanAdmin() {
  ...
  async function handleBuscar() {
    ...
    try {
      ...
      const res = await axios.post(`${API_BASE_URL}/inspeccion_epcc_bomberman_admin/buscar`, body);
  ...
  async function handleDescargar(tipo) {
    ...
    try {
      ...
      const res = await axios.post(`${API_BASE_URL}/inspeccion_epcc_bomberman_admin/descargar`, body, { responseType: 'blob' });
      ...
      link.href = url;
      link.setAttribute('download', tipo === 'excel' ? 'inspeccion_epcc.xlsx' : 'inspeccion_epcc.zip');
