...
function InspeccionEPCCBombermanAdmin() {
  ...
  async function handleBuscar() {
    ...
    try {
      ...
      const res = await api.post(`/inspeccion_epcc_bomberman_admin/buscar`, body);
  ...
  async function handleDescargar(tipo) {
    ...
    try {
      ...
      const res = await api.post(`/inspeccion_epcc_bomberman_admin/descargar`, body, { responseType: 'blob' });
